...
%\end{equation}
 ...
 P_2=\left[   {\frac {a \left(  {b}^{2}-\delta \right) }{   a^2-b^2 
 	...
 	\[L=|P_2-P_3|+2|P_1-P_2|,\;\;
 	 ...
 	 Straigthforward calculations using the vertex parametrization given in \cref{prop:03-vtx-param}, lead to the stated result.
...
\textcolor{red}{ronaldo consegue inverter, ou seja dados os semi-eixos externos $a_e$, $b_e$, quais são $a_c,b_c$ (bilhar)}
