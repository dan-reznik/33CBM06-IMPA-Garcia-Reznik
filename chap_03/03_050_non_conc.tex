...
\begin{proof}
The result follows from combining \cref{eq:03-broc-R-sinw} with \cref{eq:03-broc-axes}, using the sidelengths $s_i$ of the homothetic family using the parametrization in \cref{sec:03-confocal-standard-param}.
\end{proof}
