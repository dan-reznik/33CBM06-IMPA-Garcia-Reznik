...
\end{abstract}
%%% END \input{001_abstract}

\section{Introduction.}
\label{sec:intro}
%%% BEGIN \input{002_introduction}
...
%%% END \input{002_introduction}

\section{Preliminaries: Classic Invariants.}
\label{sec:prelim}
%%% BEGIN \input{004_preliminaries}
...
%%% END \input{004_preliminaries}


\section{Invariance of Inradius-to-Circumradius Ratio.}
\label{sec:rovr}
%%% BEGIN \input{005_invariant_ratio}
...
\end{theorem}
%%% END \input{006_cosine_circle}

\section{Generalizing to $N>3$.}
\label{sec:gener}
%%% BEGIN \input{007_generalizations}
...
%%% END \input{007_generalizations}

\section{Experimental Method.}
\label{sec:experimental}
%%% BEGIN \input{008_experimental}
...
\end{figure}
%%% END \input{008_experimental}

\appendix
\section{Video List.} 
\label{app:videos}
%%% BEGIN \input{101_app_videos}
...
\label{tab:playlist}
\end{table}
%%% END \input{101_app_videos}

\section{Orbit Vertices.}
\label{app:orbit-vertices}
%%% BEGIN \input{103_app_orbit_vertices}
...
\end{align*}
%%% END \input{103_app_orbit_vertices}

%%% BEGIN \input{015_ack}

%%% END \input{015_ack}

%%% BEGIN \input{030_biblio}
...
\end{thebibliography}
%%% END \input{030_biblio}

%%% BEGIN \input{020_bios}
