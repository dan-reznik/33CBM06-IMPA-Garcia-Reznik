...
\end{align*}
\textcolor{red}{15maio: parece que foi introduzido erro. conferir}
where:
\begin{align*}
...
\hline
\makecell[lc]{conf.\\excentrals} & \textcolor{red}{ron}  &\textcolor{red}{ron} & \cref{thm:03-incenter-excenter} \\
\hline
\end{tabular}
