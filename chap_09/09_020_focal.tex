...
\end{figure}
\begin{proof}
See \cite{dolgirev2014}. A direct proof can be done computing the intersection points $\{P_1,P_2\}$ (resp.\ $\{Q_1,Q_2\}$) of the tangent lines passing through $M$ with the hyperbola (resp.\ ellipse). After this, it is straightforward to obtain that $F_1= Q_1P_1\cap P_2Q2$
...
%		\def\svgwidth{0.75\textwidth}
 %	\input{pics_tex/razao_cruzada_HH.eps_tex}
 	 \includegraphics[scale=1]{pics_08_100_confocal_retangulo.pdf}
